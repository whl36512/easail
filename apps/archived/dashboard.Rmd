---
title: "2017 Easail Market Report"
...
db<-dbConnect(RPostgres::Postgres(), host="35.202.82.25",dbname="tao", user="tao", password="tao",  port="5432")
knitr::opts_chunk$set(conneciton="db", cache=TRUE)
```
